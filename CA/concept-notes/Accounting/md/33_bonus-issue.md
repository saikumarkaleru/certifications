...
```mermaid
flowchart TD
    R["Any reserve on the Balance Sheet"] --> Q{"Did REAL value flow in - cash or realised gain?"}
    Q -->|"Yes - realised"| Q2{"Is it earmarked by statute with strings?"}
    Q -->|"No - notional or revaluation"| N["PROHIBITED - cannot mint capital from unreal profit"]
    Q2 -->|"No - freely distributable"| F["FREE RESERVE - use for BOTH fully paid bonus AND partly to fully paid"]
    Q2 -->|"Yes - Securities Premium or CRR"| S["RESTRICTED - fully paid bonus ONLY"]
    Q2 -->|"Yes - other earmarked statutory reserve"| N
```
