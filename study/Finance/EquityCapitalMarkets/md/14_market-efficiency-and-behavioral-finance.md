...
```mermaid
graph TD
  A[New information] --> B{Market efficient?}
  B -- Yes --> C[Price adjusts instantly; no edge]
  B -- Partly --> D[Biases delay/distort adjustment]
  D --> E[Anomalies: momentum, value, overreaction]
  E --> F[Opportunity for disciplined investors]
```
